...
M.configure_highlights = function()
  ...
  -- custom pojokcode
  hi(0, "StatusLine", { bg = color.dark, fg = color.silver_gray })
  hi(0, "StatusLineNC", { bg = color.dark, fg = color.silver_gray })
  hi(0, "LspReferenceText", { bg = color._74 })
  hi(0, "LspReferenceRead", { bg = color._74 })
  hi(0, "LspReferenceWrite", { bg = color._74 })
  hi(0, "illuminatedWord", { bg = color._74 })
  hi(0, "illuminatedCurWord", { bg = color._74 })
  hi(0, "illuminatedWordText", { bg = color._74 })
  hi(0, "illuminatedWordRead", { bg = color._74 })
  hi(0, "illuminatedWordWrite", { bg = color._74 })
  hi(0, "TSKeywordFunction", { fg = color.burnt_orange, italic = true })
  hi(0, "@keyword", { fg = color.burnt_orange, italic = true })
  hi(0, "@keyword.function", { fg = color.burnt_orange, italic = true })
  hi(0, "@keyword.return", { fg = color.burnt_orange, italic = true })
  hi(0, "TSKeywordOperator", { fg = color.pale_gold, italic = true })
  hi(0, "NvimTreeWinSeparator", { fg = color.medium_gray })
  hi(0, "NvimTreeIndentMarker", { fg = color.dark_grey })
  hi(0, "FloatBorder", { fg = color.medium_gray })
  hi(0, "LspInfoBorder", { fg = color.medium_gray })
  hi(0, "BorderBG", { fg = color.medium_gray })
  hi(0, "@tag.attribute", { fg = color.burnt_orange, italic = true })
  hi(0, "@tag.javascript", { fg = color.lavender })
  hi(0, "@string.special.url.html", { fg = color.green })
  hi(0, "@variable.javascript", { fg = color.lavender })
  hi(0, "@type.javascript", { fg = color.lavender })
  hi(0, "@tag.builtin.javascript", { fg = color._58 })
